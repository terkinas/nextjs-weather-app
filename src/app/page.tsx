...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-between pt-12 z-0">
      ...
      <div className='flex flex-col px-4 sticky top-0 pb-8 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:content-[`THIS`]'>
      ...
      {/* weather table */}
      <div className="z-10 w-full flex flex-col items-center justify-center px-4 pt-8 bg-white">
        <div className="w-full text-slate-800 ">
          <h4 className='font-semibold text-lg'>Weather now</h4>
          <div className="grid grid-cols-2 gap-4 w-full py-4 pt-5">
